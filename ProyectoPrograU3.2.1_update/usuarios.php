...
<td><a class="btn btn-success"href="updateestado1.php?id=<?php echo $id;?>" class="edit" title="Aprobar" data-toggle="tooltip"><i class="fas fa-edit"></i> Editar/Aprobar</a>
            </tr>
