  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" style="color:#00713d;" href="usuarios2.php">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fas fa-clipboard-list"></i> <strong>Aprobación</strong></h1>
      ...
      <div class="">
        <h4>Aprobación de Usuarios</h4>
        <p class="text-muted">Aprueba a los usuarios registrados.</p>
      </div>
      <div class="">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-success"href="update.php?id=<?php echo $id;?>" class="edit" title="Aprobar" data-toggle="tooltip"><i class="fas fa-edit"></i> Editar/Aprobar</a>
